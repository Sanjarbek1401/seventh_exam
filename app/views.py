...
from app.forms import MemberForm, ContactForm, RegisterForm
...
from .forms import ContactForm,PeopleForm
...
class EventsListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        upcoming_events = Event.objects.filter(created_at__gte=now).order_by('created_at')
